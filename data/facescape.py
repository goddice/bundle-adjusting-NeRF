...
# image_root = "/mnt/c/Users/dina1/Downloads/fsmview_trainset_images_001-020/fsmview_trainset/1/1_neutral"
# img_paths = glob.glob(f"{image_root}/*.jpg")
...
#     h,w,_ = img.shape
#     if h > w:
#         img_small = resize(img, (720, 480))
#         imageio.imsave(f"./facescape_people_1/{name}", img_small)
...
class Dataset(base.Dataset):
    ...
    def __init__(self,opt,split="train",subset=None):
        self.raw_H,self.raw_W = 720,480
        super().__init__(opt,split)
        self.root = opt.data.root or "./facescape"
